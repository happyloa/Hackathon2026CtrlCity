...
.district-eyebrow { display: flex; align-items: center; gap: 6px; color: var(--accent); font-size: 12px; margin-bottom: 5px; }.district-overview-heading h2 { font-size: 20px; font-weight: 650; }.district-overview-heading h2 > span { color: var(--muted); font-size: 12px; font-weight: 400; margin-left: 8px; white-space: nowrap; }.district-intro { font-size: 12px; color: var(--muted); margin: 7px 0 16px; }.district-clear { border: 1px solid var(--line); border-radius: 6px; background: var(--panel); min-height: 40px; padding: 6px 10px; font-size: 12px; flex-shrink: 0; }
.district-featured { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px; }.district-card { min-width: 0; display: block; text-align: left; padding: 16px; background: var(--panel); border: 1px solid var(--line); border-top: 3px solid var(--tone); border-radius: 9px; }.district-card:hover, .district-card.is-selected { border-color: var(--accent); background: color-mix(in srgb, var(--accent) 5%, var(--panel)); }.district-card-title strong { font-size: 17px; font-weight: 650; }.district-card-title svg { color: var(--muted); }.district-card-count { justify-content: start; gap: 10px; margin: 14px 0; }.district-card-count > b { font-size: 34px; line-height: 1.2; font-variant-numeric: tabular-nums; font-weight: 600; }.district-card-count > span { font-size: 12px; }.district-card-count small { display: block; font-size: 11px; color: var(--muted); }
.district-card-metrics { display: flex; justify-content: space-between; gap: 10px; font-size: 11px; color: var(--muted); }.district-card-metrics strong { display: block; color: var(--ink); font-size: 18px; font-weight: 550; margin-top: 3px; font-variant-numeric: tabular-nums; }.district-card-metrics strong small { font-size: 11px; color: var(--muted); font-weight: 400; }.district-status-bar { display: flex; height: 5px; overflow: hidden; border-radius: 4px; margin: 16px 0 10px; }.district-status-bar i { height: 100%; }.district-card-now { flex-wrap: wrap; gap: 3px; font-size: 11px; color: var(--muted); }.district-card-now > span:last-child { color: var(--accent); }.district-card-now b { font-weight: 600; color: var(--ink); }
.district-legend, .district-map-legend { display: flex; align-items: center; flex-wrap: wrap; gap: 12px; font-size: 10px; color: var(--muted); }.district-legend { margin: 12px 0; }.district-legend > span, .district-map-legend > span { display: inline-flex; align-items: center; gap: 4px; }.district-legend i, .district-map-legend i, .district-all-list i { display: inline-block; width: 7px; height: 7px; border-radius: 2px; background: var(--tone); flex-shrink: 0; }
.district-expand { width: 100%; min-height: 40px; padding: 8px 0; border-top: 1px solid var(--line); font-size: 12px; color: var(--accent); }.rotated { transform: rotate(180deg); }.district-all-list { display: grid; grid-template-columns: repeat(3, minmax(0,1fr)); gap: 8px; padding-top: 8px; }.district-all-list button { min-height: 44px; min-width: 0; display: flex; justify-content: space-between; gap: 6px; align-items: center; padding: 8px 10px; border: 1px solid var(--line); border-radius: 6px; background: var(--panel); font-size: 12px; }.district-all-list button > span { display: flex; align-items: center; gap: 5px; }.district-all-list b { font-weight: 600; }.district-all-list small { font-size: 10px; font-weight: 400; color: var(--muted); }.district-all-list .is-selected { border-color: var(--accent); }
.district-map-panel { padding: 14px 16px 10px; border: 1px solid var(--line); border-radius: 9px; background: var(--panel); }.district-map-panel header h3 { display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; }.district-map-panel header > span { font-size: 10px; color: var(--muted); }.district-map-focus { margin-top: 8px; font-size: 11px; min-height: 20px; }.district-map-focus strong { font-weight: 500; }.district-map-focus > span { color: var(--muted); }.district-map { display: block; width: 100%; height: 225px; margin: 3px auto 7px; overflow: visible; }.district-map path { fill: var(--tone); stroke: var(--panel); stroke-width: .7; cursor: pointer; vector-effect: non-scaling-stroke; }.district-map path[aria-disabled="true"] { cursor: default; }.district-map path:hover, .district-map path.hovered, .district-map path:focus-visible, .district-map path.selected { stroke: var(--ink); stroke-width: 2; outline: none; }.district-map rect { fill: var(--ink); }.district-map text { fill: var(--panel); font-size: 11px; font-weight: 600; }.district-map-legend { gap: 8px; font-size: 9px; }.district-map-source { display: block; margin-top: 8px; color: var(--muted); font-size: 9px; text-decoration: underline; text-underline-offset: 2px; }
@media (max-width: 1400px) { .district-overview { grid-template-columns: minmax(0, 1fr) 275px; gap: 16px; }.district-card { padding: 12px; }.district-card-metrics { flex-direction: column; gap: 8px; }.district-card-metrics > span { display: flex; justify-content: space-between; align-items: baseline; }.district-card-metrics strong { font-size: 16px; margin: 0; }.district-card-now > span:last-child { display: none; } }
