...
.dispatch-choice-top { justify-content: space-between; gap: 8px; }.dispatch-choice-top > b { font-size: var(--type-body1); font-weight: 650; }.dispatch-choice-score { font-size: var(--type-body2); color: var(--muted); }.dispatch-selected-label { color: var(--accent); font-size: var(--type-body2); gap: 5px; }
