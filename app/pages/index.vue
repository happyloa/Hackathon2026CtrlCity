...
const modeDescription = computed(() => sourceMode.value === 'live'
  ? '官方資料更新後，以同站、同時段歷史基線標示 30／60 分鐘風險，並轉成待確認告警與人工覆核搬運建議。'
    ...
    <template v-else-if="activeDashboard">
      ...
      <section class="dashboard-grid primary-grid">
        ...
        <div class="operation-rail">
          ...
          <StationDetailPanel :station="selectedStation" :history="selectedHistory" :horizon="horizon" :data-mode="sourceMode" :context-query="contextQuery" @close="selectedStationId = ''" />
          <LiveFeedCard
